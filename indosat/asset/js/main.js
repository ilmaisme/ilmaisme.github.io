...
$(document).ready(function () {
    ...
    var playSmart;
    playSmart = bodymovin.loadAnimation(paramSmart);
    ...
    var animation = bodymovin.loadAnimation({
        ...
        loop: true,
        autoplay: true,
        path: 'asset/json/preloader.json',
        name: 'myAnimation',
    });
