$(document).ready(function () {
    ...
    $(".-careersTrig").click(function () {
        var role = $(this).find('.careersCardRole').text(),
            company = $(this).find('.careersCardCompany').text(),
            ...
            logo = $(this).find('.careersCardLogo img').attr('src')

        $('.careersCard').removeClass('active')
        $(this).addClass('active')
        $('.careersDetCompanyName').html(company)
        ...
        if (!!link) {
            ...
            $('.careersCtaWrap').html('<button class="careersCta button buttonPrimary" onclick="triggerActive(\'.-pCareer\')">Apply</button>')
        }
