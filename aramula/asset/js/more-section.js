...
function populate(currentPage, title) {
    ...
    var panel = '<div class="profileSection__wrap mt30">\
    ...
    panel += '<div class="formSection profileForm">\
    ...
    <div class = "formWrap mt20">\
        ...
        <label for = "upload' + currentPage + '" class = "formUpload__btn button buttonPink buttonPink--small"> \
